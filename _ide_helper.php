...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\AppServiceProvider::bootCollectionMacros()
         * @param mixed $callback
         * @return \Illuminate\Support\Collection 
         * @static 
         */ 
        public static function prioritize($callback)
        {
                        return \Illuminate\Support\Collection::prioritize($callback);
        }
